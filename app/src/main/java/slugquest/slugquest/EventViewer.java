...
public class EventViewer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView eventImageView = findViewById(R.id.imageViewEventView);
        ...
        //eventImageView.setImageResource(getResources().getIdentifier(eventImageName, "drawable", getPackageName()));
